...
import { Card } from '@/components/ui/kibo-ui/landingpageui/card';
import {
  ContextMenu,
  ContextMenuContent,
  ContextMenuItem,
  ContextMenuTrigger,
} from '@/components/ui/kibo-ui/landingpageui/context-menu';
...
const getDateByMousePosition = (context: GanttContextProps, mouseX: number) => {
  const timelineStartDate =
    context.timelineData && context.timelineData.length > 0 && context.timelineData[0]
